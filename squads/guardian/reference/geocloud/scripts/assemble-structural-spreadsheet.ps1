...
.PARAMETER ProductName
  "GeoCloud" (usado só para mensagens).
...
.EXAMPLE
  powershell -File assemble-structural-spreadsheet.ps1 -ProductName GeoCloud -FragmentsDir ..\GeoCloud\docs\estrutura\_fragments -BatchOrder "G1,G2,G3,G4,G5" -OutputCsvPath ..\GeoCloud\docs\estrutura\Account_GeoCloud_resumo_estrutural.csv -GenerateXlsx
#>
param(
