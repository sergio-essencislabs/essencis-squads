...
Manter a knowledge base do framework (`geocloud-ai-framework/knowledge/`) e a knowledge base de cada produto (`.agents/memory/`) atualizadas, federadas corretamente (cross-projeto vs. específico de produto) e livres de duplicação.
