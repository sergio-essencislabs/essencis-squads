...
Reduzir a dívida técnica já identificada — em especial o drift entre o núcleo compartilhado de GeoCloud (16 classes de Conta/Identidade, hoje divergentes entre código e banco) — sem introduzir regressão.
...
- Conduzir a reconciliação do núcleo de Conta/Identidade entre GeoCloud (playbook `sincronizacao-nucleo-compartilhado.md`), usando a skill `parity-diff`.
