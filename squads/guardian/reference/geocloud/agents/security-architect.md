...
Eliminar e prevenir a recorrência das falhas de segurança já documentadas em GeoCloud: endpoints `[AllowAnonymous]` indevidos (BOLA), permissões inertes em runtime, segredos em texto plano, e configuração JWT frouxa.
