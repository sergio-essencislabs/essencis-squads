...
Fonte original: `Documents/GeoCloud/Miscelaneous/Markdown Files/ELIMS_GeoCloud_Visao_Tecnica.md` (28/07/2026). Este documento sintetiza apenas a parte cross-projeto; detalhes de implementação ficam em `docs/system/attribute-mapping.md` de cada produto.
...
- `FunctionalityType`: GeoCloud usa 1=Sistema/2=Conta/3=Empresa.
