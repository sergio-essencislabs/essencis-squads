...
Reaproveitar o investimento já feito na campanha de fuzz V7 do GeoCloud (100 fuzz runners, matrizes em `Miscelaneous/*.xlsx`) como padrão de auditoria contínua, em vez de reinventar a verificação de permissão do zero a cada tarefa.
