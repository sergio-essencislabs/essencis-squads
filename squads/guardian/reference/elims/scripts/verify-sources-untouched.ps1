<#
.SYNOPSIS
  Garante que uma pasta de código-fonte original (ex.: ELIMS,
  ELIMS) não foi alterada durante uma tarefa. Captura um inventário
...
.PARAMETER SourcePath
  Caminho absoluto da pasta a proteger (ex.: C:\...\ELIMS\ELIMS).
...
.EXAMPLE
  powershell -File verify-sources-untouched.ps1 -Mode Baseline -SourcePath "C:\...\ELIMS" -ManifestPath "C:\...\_verification\geocloud.json"
  powershell -File verify-sources-untouched.ps1 -Mode Verify   -SourcePath "C:\...\ELIMS" -ManifestPath "C:\...\_verification\geocloud.json"
#>
param(
