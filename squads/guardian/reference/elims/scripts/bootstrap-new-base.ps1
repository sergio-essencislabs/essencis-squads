...
.PARAMETER SourcePath
  Caminho absoluto do produto original (ex.: C:\...\ELIMS\ELIMS).

.PARAMETER DestPath
  Caminho absoluto da nova base (ex.: C:\...\ELIMS\sandbox-geocloud).

.PARAMETER ProductName
  Nome do produto, para o BASELINE.md (ex.: "ELIMS").

.EXAMPLE
  pwsh ./bootstrap-new-base.ps1 -SourcePath "C:\...\ELIMS\ELIMS" -DestPath "C:\...\ELIMS\sandbox-geocloud" -ProductName "ELIMS"
#>
param(
...
Esta base foi criada pelo playbook ``onboarding-nova-base.md`` do elims-ai-framework.
...
A partir deste ponto, esta base evolui de forma independente do produto de origem, seguindo os playbooks/agentes/policies do ``elims-ai-framework`` em ``../elims-ai-framework``.
"@
