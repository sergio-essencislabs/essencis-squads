<#
.SYNOPSIS
  Auto-validação estrutural do elims-ai-framework: frontmatter de skills/policies,
...
Write-Host "== Validação estrutural do elims-ai-framework ==" -ForegroundColor Cyan
