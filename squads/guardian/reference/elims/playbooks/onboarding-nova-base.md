...
Usado quando for necessário criar uma **cópia de trabalho** a partir de `ELIMS`
ou `ELIMS` (ou outro produto já atendido pelo framework), sem alterar a origem.
...
- Alterar o ambiente original (`ELIMS`, `ELIMS`) durante este processo — é somente leitura para a origem.
