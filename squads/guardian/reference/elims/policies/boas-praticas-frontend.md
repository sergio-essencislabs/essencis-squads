---
description: Boas práticas Angular 19 / Velzon para ELIMS
globs: **/*.ts
alwaysApply: false
---
...
- State management: respeitar a escolha já feita por produto — ELIMS usa `@ngrx/signals` (SignalStore). Trocar exige ADR do Chief Architect.
