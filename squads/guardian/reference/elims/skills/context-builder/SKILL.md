...
description: Monta o conjunto mínimo de arquivos/documentos necessários para entender uma área do código antes de trabalhar nela, priorizando índices sobre leitura exaustiva. Use ao iniciar qualquer tarefa em uma área do ELIMS ainda não lida na sessão atual.
---
...
- Camada(s) envolvida(s). Produto: ELIMS (unico atendido por este framework).
