...
description: Busca componente equivalente já existente (classe, service, repository, componente Angular, endpoint, documento) antes de criar um novo, em ELIMS. Use sempre antes de criar qualquer arquivo/classe/componente novo.
---
...
Impedir a criação de um componente que já existe (ou existe de forma equivalente no produto irmão), causa raiz de boa parte da dívida técnica já documentada entre ELIMS.
