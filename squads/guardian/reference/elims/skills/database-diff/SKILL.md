---
name: database-diff
description: Compara o schema esperado (scripts SQL/migrations do repositório) com o schema real de um banco (dump ou conexão), detectando colunas/tabelas ausentes. Use após aplicar uma migration, e periodicamente para auditar drift código×banco em ELIMS.
---
...
- Dump ou acesso ao banco real (`elims.sql` ou conexão viva).
