...
description: Mapeia todos os consumidores e efeitos colaterais de uma mudança proposta (entidade, endpoint, DTO, permissão) antes da implementação em ELIMS. Use antes de alterar qualquer contrato, entidade de domínio, permission key ou schema de banco.
---
...
- Camada(s) atingida(s). Produto: ELIMS (unico atendido por este framework).
