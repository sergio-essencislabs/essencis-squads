...
O `elims-ai-framework` é um repositório de conhecimento/processo, não de código de produto — seus "testes" validam **integridade estrutural**, não comportamento de runtime.
