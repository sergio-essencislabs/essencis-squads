---
id: GT-0092
title: "Links mortos no SPA: três no menu de perfil e uma navegação de volta que caía no vazio"
status: completed
type: bug
...
issue_url: "https://github.com/Essencis-Labs/GeoCloudAI/issues/528"
grupo_execucao: ""
...
related_adrs: []
contraparte: "GeoCloudAI/.agents/tasks/completed/GT-0092-links-mortos-no-spa.md"
depende_de: []
---

# GT-0092 — Links mortos no SPA: três no menu de perfil e uma navegação de volta que caía no vazio

## Contexto
Este arquivo foi criado pela **GT-0147** (reconciliação do acervo, Grupo B) em 12/09/2026, a partir
do par que já existia em `GeoCloudAI/.agents/tasks/completed/GT-0092-links-mortos-no-spa.md`. A GT nasceu direto no repositório de
...
> erros NG04002 no console da sessão que o Sergio deixou aberta no navegador
...
O que o par traz, e onde o objetivo real está descrito: `De onde veio`, `Os quatro`, `A varredura, e por que ela é um script e não um spec`, `Um achado que virou issue em vez de commit`, `Critérios de aceitação`.
