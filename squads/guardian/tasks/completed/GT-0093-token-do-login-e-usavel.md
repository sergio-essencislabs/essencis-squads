---
id: GT-0093
title: "O token que o login emite nunca foi testado contra um endpoint protegido"
status: completed
type: test
...
issue_url: "https://github.com/Essencis-Labs/GeoCloudAI/issues/530"
grupo_execucao: ""
...
related_adrs: []
contraparte: "GeoCloudAI/.agents/tasks/completed/GT-0093-token-do-login-e-usavel.md"
depende_de: []
---

# GT-0093 — O token que o login emite nunca foi testado contra um endpoint protegido

## Contexto
Este arquivo foi criado pela **GT-0147** (reconciliação do acervo, Grupo B) em 12/09/2026, a partir
do par que já existia em `GeoCloudAI/.agents/tasks/completed/GT-0093-token-do-login-e-usavel.md`. A GT nasceu direto no repositório de
...
> pergunta feita a mim mesmo depois da GT-0084: mudei a validação de token de TODA requisição autenticada — o que prova que o login ainda funciona?
...
O que o par traz, e onde o objetivo real está descrito: `O descuido foi meu`, `Como cheguei aqui`, `Os três testes, e por que são três`, `Critérios de aceitação`.
