---
id: GT-0074
title: "Cobertura estrutural de permissão: nenhuma action nova entra sem guarda"
status: completed
type: test
...
issue_url: "https://github.com/Essencis-Labs/GeoCloudAI/issues/23"
grupo_execucao: ""
owner: sergio-essencislabs
created_at: 2026-09-10
updated_at: 2026-09-10
affected_modules: ["Back.ApiTests"]
related_adrs: []
contraparte: "GeoCloudAI/.agents/tasks/completed/GT-0074-cobertura-estrutural-de-permissao.md"
depende_de: []
---

# GT-0074 — Cobertura estrutural de permissão: nenhuma action nova entra sem guarda

## Contexto
Este arquivo foi criado pela **GT-0147** (reconciliação do acervo, Grupo B) em 12/09/2026, a partir
do par que já existia em `GeoCloudAI/.agents/tasks/completed/GT-0074-cobertura-estrutural-de-permissao.md`. A GT nasceu direto no repositório de
...
> issue #23 (testar todos os endpoints e verificar as permissões), atacada pela via estrutural depois que a campanha mostrou seus limites
...
O que o par traz, e onde o objetivo real está descrito: `Por que estrutural, e não só a campanha`, `A medida de 2026-09-10`, `O desenho: duas listas, e a diferença entre elas é o ponto`, `Regras de negócio`, `Critérios de aceitação`, `O que a medição achou`, `Dívida remanescente`.
