---
id: GT-0112
title: "O GeoCloud AI Chat em página cheia não tem como voltar ao painel reduzido"
status: completed
type: fix
...
issue_url: "https://github.com/Essencis-Labs/GeoCloudAI/issues/564"
grupo_execucao: ""
owner: Sergio
...
related_adrs: []
contraparte: "GeoCloudAI/.agents/tasks/completed/GT-0112-chat-em-pagina-cheia-nao-minimiza.md"
depende_de: []
---

# GT-0112 — O GeoCloud AI Chat em página cheia não tem como voltar ao painel reduzido

## Contexto
Este arquivo foi criado pela **GT-0147** (reconciliação do acervo, Grupo B) em 12/09/2026, a partir
do par que já existia em `GeoCloudAI/.agents/tasks/completed/GT-0112-chat-em-pagina-cheia-nao-minimiza.md`. A GT nasceu direto no repositório de
...
> Sergio, na revisão da apresentação semanal de 14/09 — print 3
...
O que o par traz, e onde o objetivo real está descrito: `Contexto`, `Problema`, `Correção`, `Definition of Done`, `Verificação`, `Achado colateral, não corrigido`.
