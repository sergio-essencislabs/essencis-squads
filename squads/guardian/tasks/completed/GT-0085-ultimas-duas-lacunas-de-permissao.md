---
id: GT-0085
title: "As duas últimas ações de dívida comum sem chave de permissão"
status: completed
type: security
...
issue_url: "https://github.com/Essencis-Labs/GeoCloudAI/issues/513"
grupo_execucao: ""
...
related_adrs: []
contraparte: "GeoCloudAI/.agents/tasks/completed/GT-0085-ultimas-duas-lacunas-de-permissao.md"
depende_de: []
---

# GT-0085 — As duas últimas ações de dívida comum sem chave de permissão

## Contexto
Este arquivo foi criado pela **GT-0147** (reconciliação do acervo, Grupo B) em 12/09/2026, a partir
do par que já existia em `GeoCloudAI/.agents/tasks/completed/GT-0085-ultimas-duas-lacunas-de-permissao.md`. A GT nasceu direto no repositório de
...
> LacunasConhecidas da GT-0074; as últimas duas entradas que eram descuido e não decisão
...
O que o par traz, e onde o objetivo real está descrito: `Não é vazamento, e a task não finge que é`, `O backfill, e por que aqui é estreitamento sem ressalva`, `O que isto muda em `LacunasConhecidas``, `Critérios de aceitação`.
