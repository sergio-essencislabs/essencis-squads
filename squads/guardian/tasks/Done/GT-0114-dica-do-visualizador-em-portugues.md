---
id: GT-0114
title: "A dica do botão de IA do visualizador está em português e usa o nome interno "Neural""
status: completed
type: fix
...
issue_url: "https://github.com/Essencis-Labs/GeoCloudAI/issues/567"
grupo_execucao: ""
owner: Sergio
...
related_adrs: []
contraparte: "GeoCloudAI/.agents/tasks/completed/gt-0114-dica-do-visualizador-em-portugues.md"
depende_de: []
---

# GT-0114 — A dica do botão de IA do visualizador está em português e usa o nome interno "Neural"

## Contexto
Este arquivo foi criado pela **GT-0147** (reconciliação do acervo, Grupo B) em 12/09/2026, a partir
do par que já existia em `GeoCloudAI/.agents/tasks/completed/gt-0114-dica-do-visualizador-em-portugues.md`. A GT nasceu direto no repositório de
...
O que o par traz, e onde o objetivo real está descrito: `Problema`, `Correção`, `Definition of Done`, `Verificação`.
