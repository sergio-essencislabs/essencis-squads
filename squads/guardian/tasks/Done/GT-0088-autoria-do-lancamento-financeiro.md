---
id: GT-0088
title: "Autoria do lançamento financeiro nunca era gravada"
status: completed
type: bug
...
issue_url: "https://github.com/Essencis-Labs/GeoCloudAI/issues/519"
grupo_execucao: ""
...
related_adrs: []
contraparte: "GeoCloudAI/.agents/tasks/completed/GT-0088-autoria-do-lancamento-financeiro.md"
depende_de: []
---

# GT-0088 — Autoria do lançamento financeiro nunca era gravada

## Contexto
Este arquivo foi criado pela **GT-0147** (reconciliação do acervo, Grupo B) em 12/09/2026, a partir
do par que já existia em `GeoCloudAI/.agents/tasks/completed/GT-0088-autoria-do-lancamento-financeiro.md`. A GT nasceu direto no repositório de
...
> item 3 da issue #511, levantada pelo geocloud-permission-auditor na revisão do PR #509
...
O que o par traz, e onde o objetivo real está descrito: `A escolha que precisa estar escrita: a baixa não sobrescreve a autoria`, `Por que este módulo escapou da varredura da #211`, `Critérios de aceitação`.
