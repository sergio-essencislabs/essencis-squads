---
id: GT-0089
title: "Baixa de lançamento marcava pago sem mover o saldo — e o TransactionScope do projeto não alista"
status: completed
type: bug
...
issue_url: "https://github.com/Essencis-Labs/GeoCloudAI/issues/523"
grupo_execucao: ""
...
related_adrs: []
contraparte: "GeoCloudAI/.agents/tasks/completed/GT-0089-baixa-atomica-e-transactionscope-decorativo.md"
depende_de: []
---

# GT-0089 — Baixa de lançamento marcava pago sem mover o saldo — e o TransactionScope do projeto não alista

## Contexto
Este arquivo foi criado pela **GT-0147** (reconciliação do acervo, Grupo B) em 12/09/2026, a partir
do par que já existia em `GeoCloudAI/.agents/tasks/completed/GT-0089-baixa-atomica-e-transactionscope-decorativo.md`. A GT nasceu direto no repositório de
...
> notado ao ler o código para escrever a issue #521; o segundo achado apareceu porque a primeira correção falhou no teste
...
O que o par traz, e onde o objetivo real está descrito: `O defeito`, `A correção que não corrigiu, e como ela apareceu`, `Como a atomicidade foi provada sem simular queda de conexão`, `Uma decisão de desenho`, `Critérios de aceitação`.
