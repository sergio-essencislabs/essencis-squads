---
id: GT-0075
title: "Logistics e OperationalDashboard expunham 25 ações sem autenticação"
status: completed
type: security
...
issue_url: "https://github.com/Essencis-Labs/GeoCloudAI/issues/498"
grupo_execucao: ""
...
related_adrs: []
contraparte: "GeoCloudAI/.agents/tasks/completed/GT-0075-logistics-e-dashboard-sem-autenticacao.md"
depende_de: []
---

# GT-0075 — Logistics e OperationalDashboard expunham 25 ações sem autenticação

## Contexto
Este arquivo foi criado pela **GT-0147** (reconciliação do acervo, Grupo B) em 12/09/2026, a partir
do par que já existia em `GeoCloudAI/.agents/tasks/completed/GT-0075-logistics-e-dashboard-sem-autenticacao.md`. A GT nasceu direto no repositório de
...
> medição da GT-0074: 699 actions com [RequiredPermission], 39 sem
...
O que o par traz, e onde o objetivo real está descrito: `O que estava aberto`, `O que reduz a gravidade, e o que não reduz`, `Nada quebra, e foi verificado antes de mexer`, `Aguardando decisão`.
