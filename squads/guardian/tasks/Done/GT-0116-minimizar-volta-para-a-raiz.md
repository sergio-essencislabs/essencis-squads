---
id: GT-0116
title: "Minimizar o chat em página cheia voltava sempre para a raiz, e não para a tela anterior"
status: completed
type: fix
...
issue_url: "https://github.com/Essencis-Labs/GeoCloudAI/issues/569"
grupo_execucao: ""
owner: Sergio
...
related_adrs: []
contraparte: "GeoCloudAI/.agents/tasks/completed/gt-0116-minimizar-volta-para-a-raiz.md"
depende_de: []
---

# GT-0116 — Minimizar o chat em página cheia voltava sempre para a raiz, e não para a tela anterior

## Contexto
Este arquivo foi criado pela **GT-0147** (reconciliação do acervo, Grupo B) em 12/09/2026, a partir
do par que já existia em `GeoCloudAI/.agents/tasks/completed/gt-0116-minimizar-volta-para-a-raiz.md`. A GT nasceu direto no repositório de
...
> Sergio, na revisão da apresentação semanal de 14/09
...
O que o par traz, e onde o objetivo real está descrito: `Contexto`, `Problema`, `Correção`, `Definition of Done`, `Verificação`.
